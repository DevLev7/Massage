...
<!-- <div id="skrollr-body"> -->
	<div id="content-scroll" data-scrollbar="true">
	...
	<script defer src="<?php echo THEME_JS; ?>/swiper-bundle.min.js"></script>
	<script src="<?php echo THEME_JS; ?>/gsap.min.js"></script>
	<script src="<?php echo THEME_JS; ?>/ScrollTrigger.min.js"></script>
