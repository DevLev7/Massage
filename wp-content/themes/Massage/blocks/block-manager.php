...
$manager_form = get_field($field_preffix_hero.'manager-form',$field_postfix);
	...
	<section id="manager" class="manager-1">
		<!-- <picture>
            <source srcset="<?php echo THEME_IMAGES; ?>/man_boy.webp" type="image/webp">
           
        </picture> -->
		<!-- <picture>
            <source srcset="<?php echo THEME_IMAGES; ?>/man_mob.webp" type="image/webp">
            <img class=" lazy man_mob" data-src="<?php echo THEME_IMAGES; ?>/man_mob.png">
        </picture> -->
		<img class="man_boy lazy" data-src="<?php echo THEME_IMAGES; ?>/man_boy.webp">
		<img class=" lazy man_mob" data-src="<?php echo THEME_IMAGES; ?>/man_mob.webp">
