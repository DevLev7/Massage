		<div class="form form-style-1 hideLabels">
            ...
            <form method="POST" action="<?php echo $formUrl ? $formUrl : get_page_link(get_page_by_title('Страница благодарности'));?>" class="form_block" enctype="multipart/form-data">
				...
				<div class="form-group animate-top custom-select">
						<select>
						<option value="0">Какой курс вы хотите попробовать? </option>
							<option value="1">Занятия для 1-го полугодия</option>
							<option value="2">Занятия для 2-го полугодия</option>
				...
				<div class="form-group animate-top custom-select">
						<select>
						<option value="0">Куда прислать ссылку?*</option>
							<option value="1">WatsApp</option>
